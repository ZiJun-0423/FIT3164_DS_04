...
def get_all_matches():
    ...
    try:
        ...
        return jsonify([{"date": match.date, "match_id": match.id, "round_num": match.round_num, "team1_id": match.team1_id, "team2_id": match.team2_id, "team1_score": match.team1_score, "team2_score":match.team2_score, "winner":match.winner, "home_team":match.home_team_id, "venue": match.venue } for match in matches]), 200
